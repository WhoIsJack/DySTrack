...
from mate.manager.feedback import send_coords_txt, send_coords_winreg
    ...
    while True:
        ...
        if new_paths != paths:
            ...
            for f in new_files:
                ...
                if (
                    os.path.split(f)[1].startswith(fileStart)
                    ...
                    # Handle unexpected failures
                        ...
                        warn(
                            "IMAGE ANALYSIS FAILED! Using previous position..."
                        )
                    ...
                    # Try to handle error cases
                        ...
                        if write_winreg:
                            ...
                            raise NotImplementedError(
                                "No fallback option implemented yet for failure to write coordinate text file."
                            )  # TODO!

                        # Report if this final attempt worked or not
                        if no_error:
                            warn(
                                "Coordinate communication failed! Using previous coordinates."
                            )
                        else:
                            warn(
                                "TERMINAL FAILURE OF SCOPE COMMUNICATION! "
