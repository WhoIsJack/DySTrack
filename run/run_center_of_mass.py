...
from dystrack.pipelines.center_of_mass import analyze_image as image_analysis_func
...
# Method: Use "objct" for bright membrane labeling, "raw" for sparse labeling, 
#         and "otsu" otherwise (compact objects, dense labeling)
analysis_kwargs = {
    "method"      : "objct",
    "gauss_sigma" : 3,
    "verbose"     : True,
