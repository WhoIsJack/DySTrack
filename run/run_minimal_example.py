...
from dystrack.pipelines.minimal_example import analyze_image as image_analysis_func
...
# In this minimal example pipeline, there are no parameters that affect image
# processing itself, but the "verbose" keyword sets whether the pipeline prints
...
# - Start DySTrack by running `python run_minimal_example.py <target_dir> [args]`
...
#   `import run.run_minimal_example as run_com`
