...
@descript:  MATE config file for tracking/stabilization of neuromast organs
...
from dystrack.pipelines.lateral_line_organ import analyze_image as image_analysis_func
...
# - Start MATE by running `python run_lateral_line_organ.py <target_dir> [args]`
...
# - You can then load the configs here using `import run_lateral_line_organ.py as *`
